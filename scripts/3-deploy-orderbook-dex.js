...
const CONTRACT_NAME = "OrderbookDEX";
...
async function deploy() {
  ...
  const contract = await factory.deploy(deployInfo.USDTToken);
...
// Run: npx hardhat run ./scripts/3-deploy-orderbook-dex.js --network bsctestnet